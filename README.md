...
<p align="left">
  <img src="/graphics/Judicial Districts.JPG" width="450" title="Judicial Districts"><br>
</p>
...
<p align="left">
  <img src="/graphics/Case Volume against Success.JPG" width="450" title="Case Volume against Success"><br>
  <em>The case volume for each district graphed against the success rate for Chapter 13 cases in that district, presented with a trend line.</em>
</p>

# Neural Network:

<p align="left">
  <img src="/graphics/Accuracy Diversion.png" width="450" title="Accuracy Diversion"><br>
  <em>Shows the divergence of the neural network's accuracy on the training set from its accuracy on the test set as the neural network trains.</em>
</p>
...
<p align="left">
  <img src="/graphics/Tree Sample.jpg" width="450" title="Tree Sample"><br>
  <em>A small sample of the decision tree model. The complete model has over 7,000 of these decision points.</em>
</p>
...
<p align="left">
  <img src="/graphics/Conversion Trendline.png" width="450" title="Conversion Trendline"><br>
   <em>By grouping test set cases by the model's probability output, and calculating the accuracy for each subgroup of cases, we can extract a polynomial regression line that can then be used to calculate the probability of success for any case.</em>
</p>
